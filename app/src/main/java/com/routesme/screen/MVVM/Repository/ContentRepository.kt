...
class ContentRepository(val context: Context) {
    ...
    private fun getData (): MutableList<Data> {
        ...
        val video1 = Data("5","video","https://firebasestorage.googleapis.com/v0/b/kidsedu-69ac7.appspot.com/o/00000%2FShukran%204th%20Ring%20Screen.mp4?alt=media&token=7e69dfa5-834a-47c0-8ddc-5c2d72ace6e7",qrCode1)
        val video2 = Data("6","video","https://firebasestorage.googleapis.com/v0/b/kidsedu-69ac7.appspot.com/o/00000%2Fbig%20sale%20sep%20video.mp4?alt=media&token=4096652b-8fe5-481a-b691-7bad7d2a8bcd",null)
