...
class ContentRepository(val context: Context) {
    ...
    private fun getData(): MutableList<Data> {
        val qrCode1 = Promotion("30% off at place 2  30% off at place 2  ","Grab it now!","322792971","https://firebasestorage.googleapis.com/v0/b/buy-me-a3db2.appspot.com/o/Qrcodes%2Flogo%2Fhuawei.svg?alt=media&token=ca5bd550-e6c1-4e18-a331-a568ae62360b", type ="coupons")
        val qrCode2 = Promotion("McDonald's offers a 30% discount, valid till 20/11/2020 McDonald's offers a 30% discount, valid till 20/11/2020","Scan Now!","cskJhlOmpq","https://firebasestorage.googleapis.com/v0/b/buy-me-a3db2.appspot.com/o/Qrcodes%2Flogo%2Fmac2.png?alt=media&token=b93837ce-a860-4092-bd2f-c1774b0a1eb5", type ="places")
        ...
        val video1 = Data("5","video","https://firebasestorage.googleapis.com/v0/b/kidsedu-69ac7.appspot.com/o/Routes%2Fnew%2FHuawei_db3014e9-6f0d-409d-8f4e-bce22b7bfaaf.mp4?alt=media&token=da43d46b-fe1b-414d-91a3-28ea2ea03911",null)
        val video2 = Data("6","video","https://firebasestorage.googleapis.com/v0/b/kidsedu-69ac7.appspot.com/o/Routes%2Fnew%2FKFC_a770a23c-0f1f-46b8-bc24-963b4d9e0838.mp4?alt=media&token=ca28c382-62b1-4c63-b544-9a3c16fee39f",null)
        val video3 = Data("7","video","https://firebasestorage.googleapis.com/v0/b/kidsedu-69ac7.appspot.com/o/Routes%2Fnew%2FMcDonald's_321c3000-3c77-452b-a44a-d88a47097654.mp4?alt=media&token=41d191f7-8214-4fd4-8ea7-a189f4e97e14",null)
