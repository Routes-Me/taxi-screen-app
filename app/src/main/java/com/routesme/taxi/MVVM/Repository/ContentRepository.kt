...
class ContentRepository(val context: Context) {
    ...
    private fun getData (): MutableList<Data> {
        ...
        val video4 = Data("8","video","https://storage.googleapis.com/exoplayer-test-media-0/BigBuckBunny_320x180.mp4",qrCode1)
        val video5 = Data("9","video","https://storage.googleapis.com/exoplayer-test-media-0/BigBuckBunny_320x180.mp4",qrCode3)
        val video6 = Data("10","video","https://storage.googleapis.com/exoplayer-test-media-0/BigBuckBunny_320x180.mp4",qrCode1)
        val video7 = Data("11","video","https://storage.googleapis.com/exoplayer-test-media-0/BigBuckBunny_320x180.mp4",qrCode3)
