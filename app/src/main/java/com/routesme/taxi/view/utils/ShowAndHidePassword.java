package com.routesme.taxi.view.utils;
...
public class ShowAndHidePassword extends AppCompatEditText {
    ...
    public ShowAndHidePassword(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public ShowAndHidePassword(Context context, AttributeSet attrs, int defStyle) {
