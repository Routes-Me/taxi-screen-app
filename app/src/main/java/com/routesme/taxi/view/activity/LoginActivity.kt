...
import com.routesme.taxi.data.model.LoginResponse
import com.routesme.taxi.data.model.SignInCredentials
import com.routesme.taxi.viewmodel.LoginViewModel
        ...
        loginViewModel.signIn(signInCredentials, this).observe(this, Observer<LoginResponse> {
            ...
            if (it != null) {
                if (it.isSuccess) {
                    ...
                    Log.d("RefreshTokenTesting", "ReceivedCookiesInterceptor... Received access token: $token")
