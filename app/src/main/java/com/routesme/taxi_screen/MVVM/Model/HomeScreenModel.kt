...
class WifiCell(val name: String, val password: String, val qrCode: com.routesme.taxi_screen.MVVM.Model.QrCode?) : ISideFragmentCell
class DateCell(val clock: String, val weekDay: String, val monthDay: String) : ISideFragmentCell

interface QRCodeCallback {
    fun onVideoQRCodeChanged(qrCode: com.routesme.taxi_screen.MVVM.Model.QrCode?)
    fun onBannerQRCodeChanged(qrCode: com.routesme.taxi_screen.MVVM.Model.QrCode?)
}
