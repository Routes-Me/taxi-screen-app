...
class ContentRepository(val context: Context) {
    ...
    private fun getData (): MutableList<Data> {
        ...
        val video2 = Data("5822","video","https://firebasestorage.googleapis.com/v0/b/buy-me-a3db2.appspot.com/o/Best%2FShukran%204th%20Ring%20Screen.mp4?alt=media&token=d2f5cf31-6a86-4409-bfff-9830d71d2291",qrCode3)
