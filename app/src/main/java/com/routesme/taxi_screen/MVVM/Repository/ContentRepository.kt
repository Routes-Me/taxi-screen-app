...
class ContentRepository(val context: Context) {
    ...
    private fun getData (): MutableList<Data> {
        ...
        val qrcode2 = QrCode("Macdonalds offers a 30% discount, valid till 20/11/2020","https://firebasestorage.googleapis.com/v0/b/buy-me-a3db2.appspot.com/o/00000.png?alt=media&token=4a5f5534-4bae-4dac-b9d5-ad7494af29ad")
        ...
        val qrcode4 = QrCode("KFC offers a 60% discount, valid till 16/12/2020","https://firebasestorage.googleapis.com/v0/b/buy-me-a3db2.appspot.com/o/00000.png?alt=media&token=4a5f5534-4bae-4dac-b9d5-ad7494af29ad")
