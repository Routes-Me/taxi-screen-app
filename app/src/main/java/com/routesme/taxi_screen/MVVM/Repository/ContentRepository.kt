...
class ContentRepository(val context: Context) {
    ...
    private fun getData (): MutableList<Data> {
        val qrcode1 = QrCode("Big Sale !","https://firebasestorage.googleapis.com/v0/b/buy-me-a3db2.appspot.com/o/Best%2FBEST%20QR%20CODE.jpg?alt=media&token=efd3c26e-57b8-4be0-8362-15bfb21beaf9")
        val qrcode2 = QrCode("Macdonalds offers a 30% discount, valid till 20/11/2020","https://firebasestorage.googleapis.com/v0/b/buy-me-a3db2.appspot.com/o/Best%2Fqr_code_2.svg?alt=media&token=0f76bad8-8f0c-49a5-9f9c-23ff3dc87fb2")
        val qrcode3 = QrCode("Burger King offers a 70% discount","https://firebasestorage.googleapis.com/v0/b/buy-me-a3db2.appspot.com/o/00000.png?alt=media&token=4a5f5534-4bae-4dac-b9d5-ad7494af29ad")
        val qrcode4 = QrCode("KFC offers a 60% discount, valid till 16/12/2020","https://firebasestorage.googleapis.com/v0/b/buy-me-a3db2.appspot.com/o/Best%2Fqr_code_2.svg?alt=media&token=0f76bad8-8f0c-49a5-9f9c-23ff3dc87fb2")
