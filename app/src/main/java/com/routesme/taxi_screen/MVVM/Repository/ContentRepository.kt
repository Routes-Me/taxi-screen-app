...
class ContentRepository(val context: Context) {
    ...
    private fun getData (): MutableList<Data> {
        val qrcode1 = QrCode("Macdonalds offers a 30% discount","https://firebasestorage.googleapis.com/v0/b/usingfirebasefirestore.appspot.com/o/000000000%2F1.png?alt=media&token=24e4ed47-e77f-489a-bb87-36955ba85b84")
        val qrcode2 = QrCode("Macdonalds offers a 30% discount, valid till 20/11/2020","https://firebasestorage.googleapis.com/v0/b/usingfirebasefirestore.appspot.com/o/000000000%2F2.png?alt=media&token=071c6c0d-0959-4a5e-99fe-49b01eb21977")
        val qrcode3 = QrCode("Burger King offers a 70% discount","https://firebasestorage.googleapis.com/v0/b/usingfirebasefirestore.appspot.com/o/000000000%2F1.png?alt=media&token=24e4ed47-e77f-489a-bb87-36955ba85b84")
        val qrcode4 = QrCode("KFC offers a 60% discount, valid till 16/12/2020","https://firebasestorage.googleapis.com/v0/b/usingfirebasefirestore.appspot.com/o/000000000%2F2.png?alt=media&token=071c6c0d-0959-4a5e-99fe-49b01eb21977")
