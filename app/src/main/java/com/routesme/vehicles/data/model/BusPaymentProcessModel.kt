...
data class BusPaymentProcessCredentials(var api_key: String = BuildConfig.NEW_API_KEY, var api_secret: String = BuildConfig.NEW_API_SECRET, var SecondID: String? = null, var PaymentCode: String? = null, var Value: Int? = null, var UserID: String? = null)
