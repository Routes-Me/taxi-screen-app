...
data class BusPaymentProcessCredentials(var api_key: String = BuildConfig.NEW_API_KEY, var api_secret: String = BuildConfig.NEW_API_SECRET, var Value: Double? = null, var paymentCode: String? = null, var SecondId: String? = null)
