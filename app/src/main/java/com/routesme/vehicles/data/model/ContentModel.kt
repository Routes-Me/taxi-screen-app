...
data class Data(val contentId: String? = null, val resourceNumber: String? = null, val type: String? = null, val url: String? = null, val tintColor: Int? = null, val promotion: Promotion? = null) : Parcelable {
