...
enum class MasterItemType(val title: String) { Info("Info"), Driver("Driver"), Account("Account"), Settings("Settings"), RoutesAndTickets("Routes & Tickets") , BusInformation("Bus Information") , Location_Feeds("Location Feeds") }
