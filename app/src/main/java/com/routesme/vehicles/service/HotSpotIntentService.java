...
import com.routesme.vehicles.hotspot.MyOnStartTetheringCallback;
import com.routesme.vehicles.hotspot.MyOreoWifiManager;
import com.routesme.vehicles.service.receiver.HotSpotIntentReceiver;
...
public class HotSpotIntentService extends IntentService {
    ...
    private void hotspotOreo(boolean turnOn) {
        ...
        if (turnOn) {
            ...
            if(mMyOreoWifiManager != null) mMyOreoWifiManager.startTethering(callback);
        } else {
            if(mMyOreoWifiManager != null) mMyOreoWifiManager.stopTethering();
            stopForeground(true);
            stopSelf();
        }
    ...
    private Notification buildForegroundNotification() {
        ...
        b.setOngoing(true)
                ...
                .addAction(new NotificationCompat.Action(
                        R.drawable.turn_off, "TURN OFF HOTSPOT", pendingIntent
                ))
